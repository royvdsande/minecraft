# AGENTS.md — Minecraft 2D

Projectgids voor Codex (en voor mij). Lees dit vóór elke wijziging. Houd dit
...
- Echte **PNG's** (vierkant, onderling gelijke maat; 16×16 aanbevolen, maar
  ...
  deze map zelf. **Codex verzint of downloadt GEEN textures.**
...
- **M0 — Scaffold** ✅ toolchain, fixed-timestep loop, Pixi-canvas, AGENTS.md.
